...
The data set that this code book pertains to is located in the avr_data.txt file of this repository.
...
# Data
The avr_data.txt data file is a text file, containing space-separated values.
